...
contract ProjectIdeaContract {
    ...
    function submitProposal(
        ...
        require(!ideas[_ideaIndex].isDeleted, "Idea has been deleted");
    ...
    function deleteIdea(uint256 _ideaIndex) public {
        require(_ideaIndex < numberOfIdeas, "Idea does not exist");
        require(
            msg.sender == ideas[_ideaIndex].creator,
            "Only idea creator can delete idea"
        );
        ideas[_ideaIndex].isDeleted = true;
    }
}
